...
import static space.obminyashka.items_exchange.rest.api.ApiKey.CATEGORY;
import static space.obminyashka.items_exchange.rest.api.ApiKey.CATEGORY_ID;
import static space.obminyashka.items_exchange.util.data_producer.CategoriesDataProducer.*;

@SpringBootTest
@AutoConfigureMockMvc
class CategoryControllerIntegrationTest extends BasicControllerTest {
