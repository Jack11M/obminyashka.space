...
class AdvertisementServiceIntegrationTest {
    ...
    void findRandom12Thumbnails_shouldReturnEmpty() {
        AdvertisementFindThumbnailsRequest advertisementFindThumbnailsRequest = new AdvertisementFindThumbnailsRequest();
        advertisementFindThumbnailsRequest.setSize(12);
        final var firstTitlesGetAttempt = advertisementService.findRandomNThumbnails(advertisementFindThumbnailsRequest);
        ...
        final var secondTitlesGetAttempt = advertisementService.findRandomNThumbnails(advertisementFindThumbnailsRequest);
