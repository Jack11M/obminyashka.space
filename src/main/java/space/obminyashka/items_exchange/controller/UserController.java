...
import static space.obminyashka.items_exchange.util.ResponseMessagesHandler.ValidationMessage.INVALID_EMAIL;
...
public class UserController {
    ...
    private void validateEmail(User user, String email) throws DataConflictException {
