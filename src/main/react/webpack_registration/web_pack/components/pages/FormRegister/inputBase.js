...
const dataRegister = [
  {
    ...
    dataError: "Укажите действующий адрес электронной почты ",
    message: "This email already exists. Please, enter another email or sign in"
  },
  {
    id: "username",
...
const errorsServer = [
  ...
  {
    errorStatus: "Этот email уже существует.",
    message: "This email already exists. Please, enter another email or sign in"
  },
  {
    errorStatus: "Этот логин уже существует.",
    message: "This login already exists. Please, come up with another login"
  }
];
