const en = {
  ...
  popup: {
    ...
    selectCategory: 'Select the category first',
    addedFile: 'The file you are adding already exists.',
    pictureSelection: 'Please select a picture with extension',
    sizeFile: 'Size of your file',
    selectFile: 'Select a file less than 10 MB.',
    noSaveMore: 'You cannot save more than 10 files.',
  },
  errors: {
  ...
  addAdv: {
    ...
    district: 'Area',
    city: 'Locality',
    uploadDescription: 'Download photos of your things',
    firstUploadDescription: 'The first photo will be the cover of a product card',
