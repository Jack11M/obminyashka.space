const en = {
  ...
  popup: {
    ...
    addedFile: 'The photo you add already exists.',
    pictureSelection: 'Please select photo with extension',
    sizeFile: 'Size of your photo',
    selectFile: 'Select a photo below 10 MB.',
    noSaveMore: 'You can’t save more than 10 photos.',
  },
  errors: {
