const ru = {
	...
	errors: {
		...
		currentPassword: 'Большие и малые латинские буквы и цифры. Длина от 8 до 30 символов',
	},
	panel: {
	...
	settings: {
		...
		describe: 'Внимание! После удаления учетной записи, ваш профиль будет полностью удален из каталога сайта и многие функции перестанут быть' +
