const ru = {
  ...
  popup: {
    ...
    addedFile: 'Файл который Вы добавляете, уже существует.',
    pictureSelection: 'Пожалуйста, выберите картинку с расширением',
    sizeFile: 'Размер вашего файла',
    selectFile: 'Выберите файл меньше 10 МБ.',
    noSaveMore: 'Вы не можете сохранить больше 10 файлов.',
  },
  errors: {
  ...
  addAdv: {
    ...
    uploadDescription: 'Загрузите фотографии ваших вещей',
