const ua = {
  ...
  popup: {
    ...
    addedFile: 'Фото, яке Ви додаєте вже існує',
    pictureSelection: 'Будь ласка, виберіть фото з розширенням',
    sizeFile: 'Розмір вашого фото',
    selectFile: 'Виберіть фото менше 10 МБ.',
    noSaveMore: 'Ви не можете зберегти більше 10 фото.',
  },
  errors: {
