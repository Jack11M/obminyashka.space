const ua = {
  ...
  popup: {
    ...
    selectCategory: 'Виберіть спочатку категорію',
    addedFile: 'Файл який Ви додаєте, вже існує.',
    pictureSelection: 'Будь ласка, виберіть картинку з розширенням',
    sizeFile: 'Розмір вашого файлу',
    selectFile: 'Виберіть файл менше 10 МБ.',
    noSaveMore: 'Ви не можете зберегти більше 10 файлів.',
  },
  errors: {
