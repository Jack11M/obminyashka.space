const ua = {
	auth: {
		...
		agreement: '* Я погоджуюсь з правилами використання сервісу, а також з передачею і обробкою моїх даних. Я підтверджую своє повноліття і відповідальність за розміщення оголошень.'
	},
	errors: {
	...
	settings: {
		...
		describe: 'Увага! Після видалення облікового запису, ваш профіль буде повністю видалений з каталогу сайту і багато функцій перестануть бути доступними. Ви можете поміняти контактні дані та номери телефонів в розділі меню',
		profile: 'Профіль'
	},
	exit: {
		question: 'Вийти?',
	...
	button: {
		...
		look: 'Дивитись',
		save: 'ЗБЕРЕГТИ',
		codeConfirm: 'ВІДПРАВИТИ КОД ПІДТВЕРДЖЕННЯ',
		remove: 'ВИДАЛИТИ АКАУНТ'
	},
	header: {
		about: 'Про проект',
