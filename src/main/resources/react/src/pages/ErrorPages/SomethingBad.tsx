  ...
  return (
    <Styles.Container>
      ...
      <Styles.WrapTittleBad>
        <Styles.TittleBad>{getTranslatedText('somethingBad.error')}</Styles.TittleBad>

        <Styles.WrapperButton>
          <Styles.MainButton onClick={() => goTo('home', navigate, deactivateError)}>
            {getTranslatedText('fourOhFour.mainPage')}
          </Styles.MainButton>

          <Styles.BackButton onClick={() => goTo('', navigate, deactivateError)}>
