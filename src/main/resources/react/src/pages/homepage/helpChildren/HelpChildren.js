...
const HelpChildren = () => {
  ...
  return (
    <div className="HelpChildren">
      <h3 className="HelpChildren__title">{getTranslatedText('mainPage.helpTitle', lang)}</h3>
      <p className="HelpChildren__text">
        <strong>{getTranslatedText('mainPage.helpName', lang)}</strong> {getTranslatedText('mainPage.helpText', lang)}
      </p>
      <BtnGoodBusiness
