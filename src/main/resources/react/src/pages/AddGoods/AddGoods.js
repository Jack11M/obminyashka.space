				...
				<div className="add_inner">
					...
					<div className="change">
						...
						<div className="change_wrapper">
							<div className="change_item">Ботинки зимние <span/></div>
							<div className="change_item">Кофта на девочку 7 лет<span/></div>
							<div className="change_input-wrapper" >
								<input className="change_input" type="text" placeholder="Введите на что хотите обменяться"/>
							</div>
						</div>
						<CheckBox
					...
					<div className="files">
						...
						<div className = "files_wrapper">
							<input id="file-input1" className = "file_input" type="file" name="file" multiple/>
								<label htmlFor="file-input1" className = "files_label added"><span/></label>
							<input id="file-input2" className = "file_input " type="file" name="file" multiple/>
								<label htmlFor="file-input1" className = "files_label "><span/></label>
						</div>
