export const validation = (state, keyInput, value) => {
  ...
  const verificationMethods = {
    ...
    lengthLogin(el) {
      return (
        el.length > this.MIN_LENGTH_STRING && el.length < this.MAX_LENGTH_STRING
      );
    },
  };
