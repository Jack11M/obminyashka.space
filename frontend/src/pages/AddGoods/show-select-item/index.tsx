  ...
  useEffect(() => {
    if (opened && !data) {
      ...
      openModal({
        ...
        children: <p style={{ textAlign: 'center' }}>{getTranslatedText(typeError)}</p>,
      });
    }
        ...
        >
          {value ? (
            <Styles.AnimatedLabel style={spring}>
              {showImg && <Styles.Image src={categoryImages[value]} alt={value} />}
                ...
                >
                  {transition((style, item) => (
                    <animated.div key={item} style={{ ...style }}>
                      ...
                      >
                        {showImg && (
                          <Styles.Image src={categoryImages[item.name]} alt={item.name} />
                        )}

                        <Styles.SelectTitle>
                          {categories && getTranslatedText(`categories.${item?.name}`)}
