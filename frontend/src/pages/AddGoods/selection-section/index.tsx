...
const SelectionSection = ({ category, subcategory, announcement }) => {
  ...
  return (
    <Styles.AddChoose>
      ...
      <Styles.Sections>
        <Styles.SectionsItem>
          <Styles.ItemDescription>{getTranslatedText('addAdv.category')}</Styles.ItemDescription>
        ...
        <Styles.SectionsItem>
          <Styles.ItemDescription>{getTranslatedText('addAdv.subcategory')}</Styles.ItemDescription>
        ...
        <Styles.SectionsItem>
          <Styles.ItemDescription>{getTranslatedText('addAdv.headline')}</Styles.ItemDescription>
