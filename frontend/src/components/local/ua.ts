const ua = {
  ...
  popup: {
    ...
    addedExchange: 'пропозиція вже добавлена у список побажань',
    pictureSelection: 'Будь ласка, виберіть фото відповідно до вказаних форматів',
  ...
  toastText: {
    changedData: 'Дані успішно змінені',
  },
  errors: {
    minPhoto: 'Мінімум 1 фото',
    fillOrCheck: 'Заповніть поле або поставте галочку',
    requireField: "Поле обов'язкове",
    ...
    max70: 'Повинно бути не більше 70 символів',
  ...
  ownActivity: {
    incomingReplies: 'Вхідні відповіді',
    outgoingReplies: 'Вихідні відповіді',
  },
  ownInfo: {
    aboutMe: 'Про себе',
    firstName: "Iм'я:",
  ...
  settings: {
    ...
    removeConfirm: 'Увага! Щоб видалити аккаунт, потрібно ввести пароль та підтвердити його.',
    removed: 'Аккаунт видалено!',
    describe:
  ...
  exit: {
    question: 'Вийти?',
    text: 'Ви не зможете залишати повідомлення та додавати оголошення!',
    exit: 'Вихід',
  },
  button: {
  ...
  categories: {
    ...
    'Vehicles For Children': 'Транспорт для дітей',
